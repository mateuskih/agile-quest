...
<strong>Sua primeira ação como Scrum Master:</strong>`,
    ...
    choices: [
      ...
      { text: "Focar apenas em otimizar cerimônias", next: "scrum-master-ceremonies-only-fail" }
    ]
  },
...
<strong>Sua resposta:</strong>`,
    ...
    choices: [
      ...
      { text: "Educar sobre valor do ciclo inspect-and-adapt", next: "scrum-master-educate-success" }
    ]
  },
...
<strong>Próxima ação:</strong>`,
    ...
    choices: [
      { text: "Implementar Definition of Done rigorosa", next: "scrum-master-dod-success" },
      { text: "Focar em práticas técnicas com o time", next: "scrum-master-technical-success" },
      { text: "Ignorar qualidade para manter velocidade", next: "scrum-master-velocity-fail" }
    ]
  },

  "scrum-master-dod-success": {
    id: "scrum-master-dod-success",
...
O Scrum Guide define que o Scrum Master serve ao Scrum Team ajudando-os a melhorar práticas. A Definition of Done é um compromisso essencial que garante transparência sobre qualidade do trabalho realizado.`,
  ...
  "scrum-master-technical-success": {
    id: "scrum-master-technical-success",
...
O Scrum Guide enfatiza que o Scrum Master serve à organização ajudando-a a entender Scrum. Isso requer tato, educação e paciência, não confronto direto que pode gerar resistência.`,
  ...
  "scrum-master-ceremonies-only-fail": {
    id: "scrum-master-ceremonies-only-fail",
...
<strong>Próximas Sprints mostram evolução consistente baseada em feedback real.</strong>`,
    ...
    choices: [
      { text: "Educar sobre valor do ciclo inspect-and-adapt", next: "scrum-master-educate-success" },
      { text: "Continuar facilitando feedback nas próximas Reviews", next: "scrum-master-feedback-cycle-success" }
    ]
  },

  "scrum-master-feedback-cycle-success": {
    id: "scrum-master-feedback-cycle-success",
...
O Scrum Guide é claro que o Sprint Goal é um compromisso. O Scrum Master deve educar sobre por que mudanças mid-Sprint são prejudiciais, não simplesmente aceitar para evitar conflito.`,
  ...
  "scrum-master-educate-success": {
    id: "scrum-master-educate-success",
...
<strong>Sua resposta baseada em dados:</strong>`,
    ...
    choices: [
      { text: "Mostrar métricas de apps similares e ROI", next: "scrum-po-metrics-success" },
...
O Scrum Guide enfatiza que Scrum Team trabalha em Sprint Goal comum. Paralelização excessiva destrói os benefícios de colaboração, inspeção e adaptação que são centrais ao Scrum.`,
  ...
  "scrum-po-metrics-success": {
    id: "scrum-po-metrics-success",
...
<strong>Sua resposta:</strong>`,
    ...
    choices: [
      ...
      { text: "Propor automação para aumentar eficiência", next: "scrum-dev-automation-success" }
    ]
  },
...
DoD fortalecida ainda mais, time orgulhoso da qualidade, você reconhecido como technical leader que entende business impact.`,
    ...
    choices: [
      { text: "Propor automação para aumentar eficiência ainda mais", next: "scrum-dev-automation-success" },
      { text: "Estabelecer métricas de qualidade contínuas", next: "scrum-dev-continuous-metrics-success" }
    ]
  },

  "scrum-dev-continuous-metrics-success": {
    id: "scrum-dev-continuous-metrics-success",
...
O Scrum Guide define Definition of Done como commitment. Comprometer quality para velocity aparente sempre backfires. Sustainable pace requer sustainable practices.`,
  ...
  "scrum-dev-automation-success": {
    id: "scrum-dev-automation-success",
